...
const InventoryItem = ({ product }) => {
  ...
  return (
    <li className="flex rounded-md bg-cyan-100 shadow-md dark:bg-gray-800 my-2 p-4">
      ...
      <div className="flex flex-col ml-6 basis-0 grow shrink">
        <div className="flex">
          <div className="basis-0 grow shrink min-w-0 ">
            <h4 className="leading-5 text-sm">
              <a
                href="#"
                className="leading-5 text-gray-800 dark:text-slate-300 text-base mt-1"
              >
                {product.name}
              </a>
            </h4>
            <p className="leading-5 dark:text-slate-300 capitalize text-sm mt-1">
        ...
        <div className="flex basis-0 grow shrink items-end justify-between pt-2">
          <p className="mt-1 text-md font-medium dark:text-slate-300 opacity-100">
            ${product.price}
          </p>
          <div className="ml-4">
            <label
            ...
            <button
              type="button"
              onClick={handleRemove}
              className="mt-0 flex items-center justify-center opacity-100 mr-3"
            >
              <span className="absolute w-[1px] h-[1px] p-0 -m-[1px] overflow-hidden whitespace-nowrap border-0">
                Remove
              </span>
