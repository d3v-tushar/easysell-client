...
const MobileSidebar = ({ open, setOpen }) => {
  ...
  return (
    <nav className="fixed w-full left-0 top-0 z-[999]">
      <div
        className={`lg:hidden text-gray-900 absolute w-3/4 md:w-2/5 h-screen
      px-7 py-2 font-medium bg-white dark:bg-gray-800 shadow-2xl top-0 duration-500 flex flex-col justify-between ${
      ...
      >
        <div>
          <button
            ...
            className="bg-black px-6 py-2 text-white font-semibold my-5 ml-[60%]"
          >
            Close
          </button>

          <ul className="mt-8 space-y-2 h-full tracking-wide">
            <li>
