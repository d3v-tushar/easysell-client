...
const Sidebar = () => {
  ...
  const linkCSS =
    "bg group flex items-center space-x-4 px-4 py-3 text-gray-600 hover:bg-sky-100";
  return (
      ...
      <div className="flex h-screen flex-col justify-between pt-2 pb-6">
        <div>
          <div className="min-w-max scale-100 flex flex-col justify-center p-2.5">
            <img
              src="https://i.ibb.co/zJmfQYY/Untitled-design-3-removebg-preview.png"
              className="w-[4vw] scale-90 group-hover:hidden"
              alt=""
            />
            <img
              src="https://i.ibb.co/mNmYcP7/Untitled-design-2-removebg-preview.png"
              className="w-[13vw] group-hover:block hidden"
              alt=""
            />
          </div>
          <ul className="mt-6 space-y-2 flex flex-col justify-center justify-items-center tracking-wide">
            <li className="min-w-max">
              ...
              >
                ...
                <span className="-mr-1 hidden group-hover:block font-medium">
                  Dashboard
                </span>
              </NavLink>
            </li>
