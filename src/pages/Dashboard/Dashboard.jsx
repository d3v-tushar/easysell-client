            ...
            {/* <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div>
                <div className="h-full group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
                  <h5 className="text-xl text-gray-700 dark:text-gray-300">Downloads</h5>
                  <div className="my-8">
                    <h1 className="text-5xl font-bold text-gray-800 dark:text-white">64,5%</h1>
                    <span className="text-gray-500 dark:text-gray-400">Compared to last week $13,988</span>
                  </div>
                  <svg
                    className="w-full"
                    viewBox="0 0 218 69"
