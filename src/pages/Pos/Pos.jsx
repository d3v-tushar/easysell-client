...
const Pos = () => {
  const { filteredProducts, isLoading, setOpen } = useContext(ProductContext);
  return (
    <div onClick={() => setOpen(false)} className="flex dark:bg-gray-900 justify-between overflow-hidden">
